...
import { CalendarOff, UserCog, Edit2, Trash2, ShieldAlert, Plus, RefreshCw } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        ...
        <div className="flex gap-2">
            ...
            <Button onClick={handleAddAbsence}>
              <Plus className="w-4 h-4 mr-2" /> Registrar Novedad
            </Button>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Registro completo de ausencias registradas.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
